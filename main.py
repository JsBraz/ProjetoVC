...
path = 'drive/MyDrive/Visão Computacional/data/proj/Atividades avi/'
...
classes_list = ["Caminhar", "Flexão", "Ler", "Trabalhar"]
...
output_directory = 'Test Videos'
os.makedirs(output_directory, exist_ok = True)

activity = 'Caminhar'
video_title = 'video_color_caminhar_joao_sem_masc'

# Getting the YouTube Video's path you just downloaded
input_video_file_path = f'{path}/{activity}/{video_title}.avi'
...
activity = 'Ler'
video_title = 'video_depth_ler_fabio_masc'
...
activity = 'Flexão'
video_title = 'video_color_flexao_fabio_masc'
...
activity = 'Trabalhar'
video_title = 'video_color_trabalhar_joao_sem_masc'
...
# Sentado (não treinado)

activity = 'Sentado'
video_title = 'video_depth_sentado_joao_masc'
